...
namespace Bongo.Web
{
    ...
    public class RoomBookingControllerTests
    {
        ...
        [Test]
        public void IndexPage_CallRequest_VeriftyGetAlInvoked()
        {
        ...
        [Test]
        public void BookRoomCheck_ModelStateIsValid_ReturnView()
        {
        ...
        public void BookRoomCheck_Successful_SuccessCodeAndRedirect()
        {
            ...
            Assert.AreEqual("Todd", actionResult.RouteValues["FirstName"]);
