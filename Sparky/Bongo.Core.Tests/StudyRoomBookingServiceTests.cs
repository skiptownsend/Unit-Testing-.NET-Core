...
namespace Bongo.Core
{
    ...
    public class StudyRoomBookingServiceTests
    {
        ...
        [Test]
        public void StudyRoomBookingReusltcheck_InputRequest_ValuesMatchInResult()
        {
        ...
        public StudyRoomBookingCode ResultCodeSuccess_RoomAvailability_ReturnsSucessResultCode(bool roomAvailability)
        {
            if (!roomAvailability)
            {
